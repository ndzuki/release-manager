...
func (s *AuthService) Login(
	...
	roles, orgID := s.userAuthorization(ctx, u.ID)
...
func (s *AuthService) RefreshToken(
	...
	roles, orgID := s.userAuthorization(ctx, ss.UserID)
...
// userAuthorization returns the user's roles and primary organization.
func (s *AuthService) userAuthorization(ctx context.Context, userID string) (roles []string, orgID string) {
