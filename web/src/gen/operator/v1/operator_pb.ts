...
export type WorkloadIdentityItem = Message<"operator.v1.WorkloadIdentityItem"> & {
   ...
   *
   * @generated from field: repeated string containers = 7;
   */
  containers: string[];
   ...
   * "not observed".
   *
   * @generated from field: map<string, string> current_image_refs = 8;
   */
   ...
   *
   * @generated from field: optional int32 current_replicas = 9;
   */
