...
type organizationMemberStore struct{ gorm *DB }

//nolint:dupl // Membership SQL remains explicit beside the distinct organization contract.
...
//nolint:dupl // Membership scanning names its composite key and errors explicitly.
