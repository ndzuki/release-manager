...
type PreflightStageResult struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *PreflightStageResult) Reset() {
	*x = PreflightStageResult{}
	mi := &file_orchestrator_v1_orchestrator_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PreflightStageResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PreflightStageResult) ProtoMessage() {}

func (x *PreflightStageResult) ProtoReflect() protoreflect.Message {
	mi := &file_orchestrator_v1_orchestrator_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PreflightStageResult.ProtoReflect.Descriptor instead.
func (*PreflightStageResult) Descriptor() ([]byte, []int) {
	return file_orchestrator_v1_orchestrator_proto_rawDescGZIP(), []int{21}
}

func (x *PreflightStageResult) GetStage() string {
	if x != nil {
		return x.Stage
	}
	return ""
...
func (x *PreflightStageResult) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *PreflightStageResult) GetDetail() string {
	if x != nil {
		return x.Detail
	}
	return ""
...
type PreflightResult struct {
	...
	FailedStage string                  `protobuf:"bytes,2,opt,name=failed_stage,json=failedStage,proto3" json:"failed_stage,omitempty"`
	Stages      []*PreflightStageResult `protobuf:"bytes,3,rep,name=stages,proto3" json:"stages,omitempty"`
...
func (x *PreflightResult) GetOverall() string {
	if x != nil {
		return x.Overall
	}
	return ""
...
func (x *PreflightResult) GetFailedStage() string {
	if x != nil {
...
func (x *PreflightResult) GetStages() []*PreflightStageResult {
	if x != nil {
		return x.Stages
	}
	return nil
...
func (x *PreflightResult) GetErrorCode() string {
	if x != nil {
		return x.ErrorCode
	}
	return ""
...
const file_orchestrator_v1_orchestrator_proto_rawDesc = "" +
	...
	"\x0fPreflightResult\x12\x18\n" +
	"\aoverall\x18\x01 \x01(\tR\aoverall\x12!\n" +
	"\ffailed_stage\x18\x02 \x01(\tR\vfailedStage\x12=\n" +
	"\x06stages\x18\x03 \x03(\v2%.orchestrator.v1.PreflightStageResultR\x06stages\x12\x1d\n" +
	"\n" +
	"error_code\x18\x04 \x01(\tR\terrorCode\"\xa0\x01\n" +
...
var file_orchestrator_v1_orchestrator_proto_goTypes = []any{
	...
	(*PreflightStageResult)(nil),                 // 36: orchestrator.v1.PreflightStageResult
	(*PreflightResult)(nil),                      // 37: orchestrator.v1.PreflightResult
	(*CancelOperationRequest)(nil),               // 38: orchestrator.v1.CancelOperationRequest
	(*CancelOperationResponse)(nil),              // 39: orchestrator.v1.CancelOperationResponse
	(*WatchOperationRequest)(nil),                // 40: orchestrator.v1.WatchOperationRequest
	(*WatchOperationResponse)(nil),               // 41: orchestrator.v1.WatchOperationResponse
	(*OperationSnapshot)(nil),                    // 42: orchestrator.v1.OperationSnapshot
	(*TimelineEntry)(nil),                        // 43: orchestrator.v1.TimelineEntry
	(*Heartbeat)(nil),                            // 44: orchestrator.v1.Heartbeat
	(*CreateReleaseDefinitionRequest)(nil),       // 45: orchestrator.v1.CreateReleaseDefinitionRequest
	(*CreateReleaseDefinitionResponse)(nil),      // 46: orchestrator.v1.CreateReleaseDefinitionResponse
	(*GetReleaseDefinitionRequest)(nil),          // 47: orchestrator.v1.GetReleaseDefinitionRequest
	(*GetReleaseDefinitionResponse)(nil),         // 48: orchestrator.v1.GetReleaseDefinitionResponse
...
func file_orchestrator_v1_orchestrator_proto_init() {
	...
	file_orchestrator_v1_orchestrator_proto_msgTypes[26].OneofWrappers = []any{
