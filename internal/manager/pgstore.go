...
func (s *PostgreSQLStore) ListCustomers(enabledOnly bool) ([]Customer, error) {
	...
	if enabledOnly { q += " WHERE enabled = true" }
	q += " ORDER BY name"
...
func (s *PostgreSQLStore) GetCustomer(id string) (*Customer, error) {
	...
	if err != nil { return nil, fmt.Errorf("customer %s not found", id) }
	return &c, nil
}
...
func (s *PostgreSQLStore) CreateCustomer(c Customer) (*Customer, error) {
	...
	if err != nil { return nil, fmt.Errorf("create customer: %w", err) }
	return &c, nil
}
...
func (s *PostgreSQLStore) UpdateCustomer(c Customer) (*Customer, error) {
	...
	if err != nil { return nil, err }
	if n, _ := r.RowsAffected(); n == 0 { return nil, fmt.Errorf("customer %s not found", c.ID) }
...
func (s *PostgreSQLStore) GetChartDefinition(orgID, chartID string) (*ChartDefinition, error) {
	...
	if err != nil { return nil, fmt.Errorf("chart %s not found", chartID) }
	return &c, nil
}
...
func (s *PostgreSQLStore) DeleteCustomerChartBinding(orgID, bindingID string) error {
	...
	if err != nil { return err }
	if n, _ := r.RowsAffected(); n == 0 { return fmt.Errorf("binding %s not found", bindingID) }
	return nil
}
...
func (s *PostgreSQLStore) ListUsers() ([]User, error) { return nil, fmt.Errorf("not implemented") }
func (s *PostgreSQLStore) GetUser(id string) (*User, error) { return nil, fmt.Errorf("not found") }
func (s *PostgreSQLStore) CreateUser(u User) error { return fmt.Errorf("not implemented") }
func (s *PostgreSQLStore) GetUserByEmail(email string) (*User, error) { return nil, fmt.Errorf("not found") }
