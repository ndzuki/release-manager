...
func main() {
	configPath := flag.String("config", "configs/notifier.dev.yaml", "path to configuration file")
	flag.Parse()
	...
	logger.Info("release-notifier started",
	...
	logger.Info("release-notifier stopped")
}
