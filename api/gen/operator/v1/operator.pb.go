...
type EnrollResponse struct {
	...
	OperatorId     string `protobuf:"bytes,4,opt,name=operator_id,json=operatorId,proto3" json:"operator_id,omitempty"`             // center-generated operator identity (REQ-015 decision 4)
