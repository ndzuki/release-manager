...
type OrchestratorServiceClient interface {
	...
	ApproveValuesRevision(context.Context, *connect.Request[v1.ApproveValuesRevisionRequest]) (*connect.Response[v1.ApproveValuesRevisionResponse], error)
	RejectValuesRevision(context.Context, *connect.Request[v1.RejectValuesRevisionRequest]) (*connect.Response[v1.RejectValuesRevisionResponse], error)
...
func NewOrchestratorServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) OrchestratorServiceClient {
	...
	return &orchestratorServiceClient{
		...
		approveValuesRevision: connect.NewClient[v1.ApproveValuesRevisionRequest, v1.ApproveValuesRevisionResponse](
			httpClient,
			baseURL+OrchestratorServiceApproveValuesRevisionProcedure,
			connect.WithSchema(orchestratorServiceMethods.ByName("ApproveValuesRevision")),
			connect.WithClientOptions(opts...),
		),
		rejectValuesRevision: connect.NewClient[v1.RejectValuesRevisionRequest, v1.RejectValuesRevisionResponse](
			httpClient,
			baseURL+OrchestratorServiceRejectValuesRevisionProcedure,
			connect.WithSchema(orchestratorServiceMethods.ByName("RejectValuesRevision")),
			connect.WithClientOptions(opts...),
...
type orchestratorServiceClient struct {
	...
	approveValuesRevision    *connect.Client[v1.ApproveValuesRevisionRequest, v1.ApproveValuesRevisionResponse]
	rejectValuesRevision     *connect.Client[v1.RejectValuesRevisionRequest, v1.RejectValuesRevisionResponse]
...
// ApproveValuesRevision calls orchestrator.v1.OrchestratorService.ApproveValuesRevision.
func (c *orchestratorServiceClient) ApproveValuesRevision(ctx context.Context, req *connect.Request[v1.ApproveValuesRevisionRequest]) (*connect.Response[v1.ApproveValuesRevisionResponse], error) {
	return c.approveValuesRevision.CallUnary(ctx, req)
}

// RejectValuesRevision calls orchestrator.v1.OrchestratorService.RejectValuesRevision.
func (c *orchestratorServiceClient) RejectValuesRevision(ctx context.Context, req *connect.Request[v1.RejectValuesRevisionRequest]) (*connect.Response[v1.RejectValuesRevisionResponse], error) {
	return c.rejectValuesRevision.CallUnary(ctx, req)
}
...
func (UnimplementedOrchestratorServiceHandler) ApproveValuesRevision(context.Context, *connect.Request[v1.ApproveValuesRevisionRequest]) (*connect.Response[v1.ApproveValuesRevisionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("orchestrator.v1.OrchestratorService.ApproveValuesRevision is not implemented"))
}

func (UnimplementedOrchestratorServiceHandler) RejectValuesRevision(context.Context, *connect.Request[v1.RejectValuesRevisionRequest]) (*connect.Response[v1.RejectValuesRevisionResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("orchestrator.v1.OrchestratorService.RejectValuesRevision is not implemented"))
}
