...
const (
	WebhookService_IngestArtifact_FullMethodName = "/webhook.v1.WebhookService/IngestArtifact"
)
...
type WebhookServiceClient interface {
	IngestArtifact(ctx context.Context, in *IngestArtifactRequest, opts ...grpc.CallOption) (*IngestArtifactResponse, error)
}
...
func (c *webhookServiceClient) IngestArtifact(ctx context.Context, in *IngestArtifactRequest, opts ...grpc.CallOption) (*IngestArtifactResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IngestArtifactResponse)
	err := c.cc.Invoke(ctx, WebhookService_IngestArtifact_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WebhookServiceServer interface {
	IngestArtifact(context.Context, *IngestArtifactRequest) (*IngestArtifactResponse, error)
...
func (UnimplementedWebhookServiceServer) IngestArtifact(context.Context, *IngestArtifactRequest) (*IngestArtifactResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method IngestArtifact not implemented")
}
...
func _WebhookService_IngestArtifact_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IngestArtifactRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WebhookServiceServer).IngestArtifact(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WebhookService_IngestArtifact_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WebhookServiceServer).IngestArtifact(ctx, req.(*IngestArtifactRequest))
	}
...
var WebhookService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "IngestArtifact",
			Handler:    _WebhookService_IngestArtifact_Handler,
		},
	},
